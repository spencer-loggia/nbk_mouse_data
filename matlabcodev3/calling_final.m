...
%trained
EXPECTED_IDS = [{'MiTg01'}, {'MiTg02'}, {'MiTg03'}, {'MiTg04'}, {'MiTg05'}, {'MiTg06'}, {'MiTg07'}, {'MiTg08'}, {'MiTg09'}, {'MiTg10'}, {'MiTg11'}, {'MiTg12'}, {'SCB02'}, {'SCB05'}, {'SCB06'}];

%add the matlab code folder to the current path
addpath('C:\Users\pbs-mysorelab\Spencer\matlabcode\');

boxdrives = [{'C:\Users\pbs-mysorelab\Spencer\matlabcode\nbk\box1'}, {'C:\Users\pbs-mysorelab\Spencer\matlabcode\nbk\box2'}, {'C:\Users\pbs-mysorelab\Spencer\matlabcode\nbk\box3'}];
subfolders = [{'.\SCB'}, {'..\MiTg'}];
    ...
    for w = 1:length(boxdrives)
        ...
        for x = 1:length(subfolders)
            ...
            while i <= num_fname
                ...
                z = 1;
                while strcmp(data.name, char(EXPECTED_IDS(z))) == 0
                    z = z + 1;
                end
