...
% cd D:\Postdoc_Mysore_lab\Research_data\behavior
 function data = plot_session_performance_v9(fname,plot_flag)
%clear all; close all;
% plot_flag = 0;
...
% verify num trials
num_trials_v = corr_vert_choice + incorr_vert_choice + missed_vert_choice + corr_horz_choice + incorr_horz_choice + missed_horz_choice;
if(num_trials ~= num_trials_v)
