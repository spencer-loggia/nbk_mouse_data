...
%trained
EXPECTED_IDS = [{'MiTg01'}, {'MiTg02'}, {'MiTg13'}, {'MiTg04'}, {'MiTg05'}, {'MiTg14'}, {'MiTg07'}, {'MiTg08'}, {'MiTg09'}, {'MiTg10'}, {'MiTg11'}, {'MiTg12'}, {'SCB_2'}, {'SCB05'}, {'SCB06'}];
...
if strcmp(fname,'today') == 1 || (isnumeric(year_num) == 1 && L == 11)
    ...
    for w = 1:length(boxdrives)
        ...
        for x = 1:length(subfolders)
            ...
            i = 1;
            while i <= num_fname
                data = plot_session_performance_v12(fname_arr{i}, plot_flag);
                z = 1;
